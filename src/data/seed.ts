  ...
  editApprovals: [
    {
      id: 'ea1',
      requesterId: 'u3',
      requesterName: 'วิชัย ขับดี',
      requesterRole: 'driver',
      vehicleId: 'v1',
      vehiclePlate: 'ABC-1234',
      reason: 'อัปเดตเลขไมล์หลังจบทริปกรุงเทพ–สงขลา',
      changes: { odometer: 247850 },
      changeFields: [
        { key: 'odometer', label: 'เลขไมล์', before: '245,320', after: '247,850' },
      ],
      requestedAt: '2026-05-16T18:42:00.000Z',
      status: 'pending',
      reviewerId: null,
      reviewerName: null,
      reviewedAt: null,
    ...
    },
    {
      ...
      reason: 'น้ำมันลดต่ำกว่าที่ระบบบันทึก ขอแก้ไขให้ตรง',
      changes: { fuel: 32 },
      changeFields: [
        { key: 'fuel', label: 'ระดับน้ำมัน (%)', before: '41', after: '32' },
      ],
      requestedAt: '2026-05-17T08:15:00.000Z',
      status: 'pending',
      reviewerId: null,
      reviewerName: null,
      reviewedAt: null,
